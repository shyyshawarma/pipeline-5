...
#         self.color_disp = UWColorRelativeDispersionLoss()
...
#         l_color_disp = self.color_disp(pred)
...
class CompositeLoss(nn.Module):
    ...
    def forward(self, pred, target):
        ...
        total = (
            ...
            self.weights["Color Dispersion"] * l_color_disp
        )
        return total
